        ...
        <table cellpadding="0" cellspacing="0" class="email-card"
          ...
          <tr>
            <td class="email-header" style="background:${C.header};padding:28px 24px;text-align:center;">
              <p style="margin:0 0 6px;font-family:'JetBrains Mono','Courier New',monospace;font-size:10px;font-weight:600;text-transform:uppercase;
                letter-spacing:0.15em;color:${C.ember};">
                What&#8217;s Up Addis
              </p>
